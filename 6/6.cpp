//Решение закрытой транспортной задачи. Такая ситуация когда количество товара требуемое потребителем равно количеству товара, которое может предоставить поставщик
